...
namespace AspMvcExample.Controllers
{
    public class GendersController : Controller
    {
        ...
        public GendersController(TradingContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name")] Gender genders)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name")] Gender genders)
        {
            if (id != genders.Id)
            {
                return NotFound();
